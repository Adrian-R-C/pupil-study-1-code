...
subplot(2,3,3)
h = daboxplot([data4{1}(:,1:3) data4{2}(:,1:3)],'xtlabels', [1 2 3 4 5 6],'whiskers',0,...
    'scatter',1,'scattersize',25,'scatteralpha',0.6,'withinlines',0,'outliers',0, 'withinlinesTwoGroup',1, 'valMax', 4);
set(gca,'FontSize',12)
hold on
