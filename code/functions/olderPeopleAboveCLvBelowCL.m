...
[significance significanceCorrected clusterCharacteristics] = CBPT_ztValueThreshold_TFCE(matrixAboveCL, matrixBelowCL, app.exponentHeightH, app.exponentExtentE, app.heightIncrementDH, app.numberOfPermutations, "independent", "both", "parametric", 0.05);
